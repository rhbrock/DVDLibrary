<%-- 
    Document   : mainPage
    Created on : Sep 20, 2018, 6:45:22 AM
    Author     : Roger Brock
--%>
                ...
                <sf:form role="form" modelAttribute="dvdsearch"
                    ...
                    <div class='col-md-3'>
                        ...
                        <sf:select class="form-control" path="searchType">
                            <option value="" label="Search Type"></option>
                ...
                <div class="modal-dialog modal-sm" >
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p>Are you sure you want to delete this Dvd from your library?</p>
                            <hr>
                        </div>
                        <div class="modal-footer" style="text-align:left" id="deleteButton">
                            <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                            <!--Model "Yes" button comes from javascript-->
                        </div>
                    </div>
